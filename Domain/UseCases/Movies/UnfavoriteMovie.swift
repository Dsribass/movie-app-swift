...
public protocol UnfavoriteMovieUseCase {
  func execute(with req: UnfavoriteMovie.Request) -> Completable
}

public final class UnfavoriteMovie: UnfavoriteMovieUseCase {
